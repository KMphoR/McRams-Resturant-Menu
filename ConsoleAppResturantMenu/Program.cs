...
namespace ConsoleAppResturantMenu
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Welcome to McRams :)");
            Console.WriteLine("***********************");
        }
        ...
        public static void KidsMenu(ArrayList orders)
        {
            while (true)
            {
                ...
                Console.WriteLine("(3)" + KidsMeals.Junior_Burger + "     R40");
                ...
                if (orderCart == 1)
                {
                    orders.Add("Happy Meal      R30");
                    total += 30;
                }
                else if (orderCart == 2)
                {
                    orders.Add("Kids Sharebox   R60");
                    total += 60;
                }
                else if (orderCart == 3)
                {
                    total += 40;
                    orders.Add("Junior Burger   R40");
                }
                else if (orderCart == 4)
                {
                    MainMenu();
        ...
        static void RegularMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("(6)" + RegularMeals.Double_Burger + "   R40");
                ...
                if (orderCart == 1)
                {
                    orders.Add("Big Mac         R65");
                    total += 65;
                }
                else if (orderCart == 2)
                {
                    orders.Add("Bic Mac Deluxe  R74");
                    total += 74;
                }
                else if (orderCart == 3)
                {
                    total += 120;
                    orders.Add("McFeast         R120");
                }
                else if (orderCart == 4)
                {
                    total += 150;
                    orders.Add("McFeast Spicy   R60");
                }
                else if (orderCart == 5)
                {
                    total += 60;
                    orders.Add("McRoyal Spicy   R40");
                }
                else if (orderCart == 6)
                {
                    total += 40;
        ...
        static void VegeterianMenu()
        {
            while (true)
            {
                ...
                {
                    orders.Add("Green Salad     R40");
                    total += 40;
                }
                else if (orderCart == 3)
                {
                    total += 45;
                    orders.Add("Veggie Burger   R45");
                }
                else if (orderCart == 4)
                {
                    MainMenu();
        ...
        static void Extras()
        {
            while (true)
            {
                ...
                if (orderCart == 1)
                {
                    orders.Add("Milkshake       R35");
                    total += 35;
                }
                else if (orderCart == 2)
                {
                    orders.Add("Oreo McFlurry   R44");
                    total += 44;
                }
                else if (orderCart == 3)
                {
